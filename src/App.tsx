  ...
  return <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-indigo-50">
      <main className="min-h-screen flex items-center justify-center p-6">
        <div className="w-full max-w-7xl">
          {currentView === 'home' && <div className="space-y-12">
              {/* Main Title Section */}
              ...
              <div className="flex justify-center">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 w-full max-w-6xl">
                  <div onClick={() => setCurrentView('staff-signin')} className="bg-white rounded-3xl shadow-xl border border-gray-100 p-8 cursor-pointer hover:shadow-2xl hover:scale-105 transition-all duration-300 group">
                  ...
                  <div onClick={() => setCurrentView('student-signin')} className="bg-white rounded-3xl shadow-xl border border-gray-100 p-8 cursor-pointer hover:shadow-2xl hover:scale-105 transition-all duration-300 group">
                  ...
                  <div onClick={() => setCurrentView('visitor-signin')} className="bg-white rounded-3xl shadow-xl border border-gray-100 p-8 cursor-pointer hover:shadow-2xl hover:scale-105 transition-all duration-300 group">
                  ...
                  <div onClick={() => setCurrentView('parent-pickup')} className="bg-white rounded-3xl shadow-xl border border-gray-100 p-8 cursor-pointer hover:shadow-2xl hover:scale-105 transition-all duration-300 group">
          ...
          {currentView === 'student-signin' && <StudentSignIn onBack={() => setCurrentView('home')} />}

          {currentView === 'visitor-signin' && <VisitorSignIn onBack={() => setCurrentView('home')} />}

          {currentView === 'parent-pickup' && <ParentPickup onBack={() => setCurrentView('home')} />}

          {currentView === 'admin-login' && <AdminLogin onLogin={handleAdminLogin} />}

          {currentView === 'admin-dashboard' && adminUser && <AdminDashboardTabs onBack={() => {
          setCurrentView('home');
          window.history.pushState({}, '', '/');
        }} onLogout={handleAdminLogout} adminData={adminUser} />}
